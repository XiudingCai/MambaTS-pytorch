...
class Model(nn.Module):
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        # prevention for x_mark_dec being single channel case
        if x_mark_dec.shape[-1] != 4:
            # x_mark_dec = x_mark_dec.repeat(1, 1, 4)
            x_mark_dec = None

        # print(x_enc.shape, x_dec.shape, x_mark_dec.shape)
